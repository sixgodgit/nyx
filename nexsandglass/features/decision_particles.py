...
def _tag_llm(question: str, choice: str) -> str:
    ...
    """
    try:
        from nexsandglass.features.sandglass_think import _llm
...
def log(question: str, choice: str, ts: str = "", chain: list = None) -> None:
    ...
    try:
        from nexsandglass.features.sandglass_think import persona_project, comprehensive_offset
...
def _has_llm() -> bool:
    ...
    try:
        from nexsandglass.l3.offset_signals import _LLM_KEY
